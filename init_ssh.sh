...
docker cp ./master_id_rsa.pub slave_node1:/root/.ssh/authorized_keys
docker cp ./master_id_rsa.pub slave_node2:/root/.ssh/authorized_keys
docker cp ./master_id_rsa slave_node1:/root/.ssh/id_rsa
docker cp ./master_id_rsa slave_node2:/root/.ssh/id_rsa
...
docker cp ./config master_node:/root/.ssh/config
docker cp ./config slave_node1:/root/.ssh/config
docker cp ./config slave_node2:/root/.ssh/config
